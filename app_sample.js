...
var MCQ_Quiz=mongoose.model('quiz_all',mcq_quizSchema);
...
router.post("/uploadQuiz",urlencodedParser,function(req,res) {
  ...
  for (var i = 0; i < mcqQuestions; i++) {
    ...
    mcq_quiz.MCQ=req.body.question_type;
    mcq_quiz.Descriptive=req.body.question_type;
    all_quiz_array.push(mcq_quiz);
  }
  for (var i = 0; i < desQuestions; i++) {
    var mcq_quiz=new MCQ_Quiz();
    mcq_quiz.id=1234;
    mcq_quiz.quiz_name=req.body.quiz_name;
    mcq_quiz.session_name=req.body.session_name;
    ...
    mcq_quiz.option3="";
    mcq_quiz.option4="";
    mcq_quiz.correct_option="";
    mcq_quiz.MCQ=req.body.question_type;
    mcq_quiz.Descriptive=req.body.question_type;
    all_quiz_array.push(mcq_quiz);
  }
  res.send(all_quiz_array);
